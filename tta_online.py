...
# CUDA_VISIBLE_DEVICES=0 python3 -m torch.distributed.run --nproc_per_node=1 --master_port=10000 tta_online.py --online_tta --seed 42 --method tcr --config configs_online_tta --output_dir output_online_tta --checkpoint checkpoint/16m_base_model_state_step_199999.th
